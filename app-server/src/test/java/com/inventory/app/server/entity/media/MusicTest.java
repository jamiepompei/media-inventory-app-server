...
public class MusicTest {
    ...
    public void testToString() {
        String expectedToString = "Music{artists=[Artist1, Artist2], songList=[Song1, Song2], releaseYear=2022, Media{id=1, title='Sample Music', genre='Rock', format='Vinyl', createdBy='null', createdOn=null, modifiedBy='null', modifiedOn=null, completed=null, onLoan=null, reviewRating=null, reviewDescription='null', collections=null, tags=null}}";
